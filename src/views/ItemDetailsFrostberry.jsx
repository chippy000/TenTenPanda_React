          ...
          <div className="row">
            ...
            <div className="col-lg-7">
              ...
              <div className="pb-8 mb-lg-6 border-bottom border-neutral-40">
                ...
                >
                  香草夾心餡如柔軟花瓣在口中綻放，包裹酸甜莓果餡，層次細膩、香氣馥郁。彷彿冬日裡的一朵靜靜盛開的雪花莓香，溫柔而動人。
                </p>
              ...
              <div className="py-8">
                <div className="mb-10">
                  ...
                  <p className="fs-7 fs-lg-6 text-neutral-80 lh-base">
                    產品內含北海道奶油與天然香草醬製成餡料、大湖草莓製成果泥、細緻奶霜層、糖霜薄層、北海道牛奶製成的甜甜圈麵糰
                  </p>
                </div>
                <div>
                  <h5 className="fs-6 fs-lg-5 fw-bold text-neutral-100 mb-5">
...
export default ItemDetailsFrostberry;
