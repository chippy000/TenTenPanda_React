          ...
          <div className="container mb-4 mb-lg-8">
            <nav>
              <ol className="breadcrumb">
                ...
                <li className="bread-item d-none d-lg-block">
                  <a href="./productList-classNameic.html" className="text-neutral-60"
                  >經典口味</a
                  >
                </li>
            ...
            <div className="row">
              ...
              <div className="col-lg-7">
                ...
                <div className="pb-8 mb-lg-6 border-bottom border-neutral-40">
                  ...
                  >
                    濃醇可可搭配香甜焦糖，<br />表層烘焙出微微焦香，甜而不膩、溫柔而濃厚<br />午後搭配拿鐵享用，讓午後時光更加迷人
                  </p>
                ...
                <div className="py-8">
                  <div className="mb-10">
                    ...
                    <p className="fs-7 fs-lg-6 text-neutral-80 lh-base">
                      選用法國進口苦甜可可粉，<br />與慢火熬煮的手工焦糖醬融合製成特製內餡，<br />外層使用微烘焙可可粒與可可糖粉，<br />熊貓耳朵使用高純度可可豆壓模製成
                    </p>
                  </div>
                  <div>
                    <h5 className="fs-6 fs-lg-5 fw-bold text-neutral-100 mb-5">
            ...
            <div className="container-lg py-14">
              ...
              <div className="row g-6">
                <div className="recommend-commodity col-6 col-lg flex-shrink-1">
                  <a
                    href="./item_details-classNameic.html"
...
export default ItemDetailsCaramelcocoa;
