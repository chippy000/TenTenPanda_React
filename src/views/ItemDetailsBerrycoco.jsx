      ...
      <section className="py-lg-14 py-8">
        ...
        <div className="container mb-4 mb-lg-8">
          <nav>
            ...
            >
              <li className="bread-item d-flex align-items-center ms-5">
                <Link to="/">
                  <img src={home} alt="" />
                </Link>
              </li>
          ...
          <div className="row">
            ...
            <div className="col-lg-7">
              ...
              <div className="pb-8 mb-lg-6 border-bottom border-neutral-40">
                ...
                >
                  以濃厚可可醬結合酸甜草莓，輕灑微融棉花糖，濃醇酸甜的口感讓每一口都像冬日熱可可般溫暖心房。
                </p>
          ...
          <div className="container-lg py-14">
            ...
            <div className="row g-6">
              <div className="recommend-commodity col-6 col-lg flex-shrink-1">
                <Link
                  to="./item_details-frostberry.html"
...
export default ItemDetailsBerrycoco;
