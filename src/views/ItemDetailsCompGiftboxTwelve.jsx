const ItemDetailsCompGiftboxTwelve = () => {
  return (
    <>
        {/* 商品詳情-綜合甜甜禮盒_12入 頁面 */}
        <section>
          ...
          <div className="container mb-4 mb-lg-8">
            <nav>
              <ol className="breadcrumb">
                ...
                <li className="bread-item d-none d-lg-block">
                  <a href="./productList-giftbox.html" className="text-neutral-60"
                  >甜甜禮盒</a
                  >
                </li>
            ...
            <div className="row">
              <div className="col-lg-5">
                <div className="mb-lg-8">
                  <img src="/綜合甜甜-禮盒-12入-去背.webp" alt="" />
                </div>
              </div>
              <div className="col-lg-7">
                ...
                <div className="pb-8 mb-lg-6 border-bottom border-neutral-40">
                  ...
                  <p
                    ...
                    style="background-color: #fef9ecbf"
                  >
                    每一盒都是我們精心搭配的隨機口味，<br />讓您每次打開都有不同驚喜。
                  </p>
            ...
            <div className="container-lg py-14">
              ...
              <div className="row g-6">
                <div className="recommend-commodity col-6 col-lg flex-shrink-1">
                  ...
                  <div className="my-1 my-lg-0 text-center">
                    <h5
                ...
                <div className="recommend-commodity col-6 col-lg flex-shrink-1">
                  ...
                  <div className="my-1 my-lg-0 text-center">
                    ...
                    <p className="fs-7 fs-lg-6 text-primary-80 lh-base">$ 360</p>
                  </div>
                </div>
                <div className="recommend-commodity col-6 col-lg flex-shrink-1">
                  <div className="ratio ratio-1x1">
                  ...
                  <div className="my-1 my-lg-0 text-center">
                    ...
                    <p className="fs-7 fs-lg-6 text-primary-80 lh-base">$ 750</p>
                  </div>
                </div>
                <div className="recommend-commodity col-6 col-lg flex-shrink-1">
                  <div className="ratio ratio-1x1">
...
export default ItemDetailsCompGiftboxTwelve;
