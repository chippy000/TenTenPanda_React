          ...
          <div className="container mb-4 mb-lg-8">
            <nav>
              <ol className="breadcrumb">
                ...
                <li className="bread-item d-none d-lg-block">
                  <a href="./productList-classic.html" className="text-neutral-60"
                  >經典口味</a
                  >
                </li>
            ...
            <div className="row">
              ...
              <div className="col-lg-7">
                ...
                <div className="pb-8 mb-lg-6 border-bottom border-neutral-40">
                  ...
                  >
                    法國生乳與新鮮檸檬完美調和，<br />內餡滑順、酸甜平衡，口感輕盈，<br />適合療癒每一個需要被陽光輕輕擁抱的時刻
                  </p>
                ...
                <div className="py-8">
                  <div className="mb-10">
                    ...
                    <p className="fs-7 fs-lg-6 text-neutral-80 lh-base">
                      使用嚴選台灣黃金檸檬現榨原汁，<br />搭配北海道生乳製成輕柔滑順的內餡，<br />微酸中帶有奶香，以獨家比例純手工製成
                    </p>
                  </div>
                  <div>
                    <h5 className="fs-6 fs-lg-5 fw-bold text-neutral-100 mb-5">
...
export default ItemDetailsCreamLemon;